...
let myOtherText = "Allow yourself to grow: do your daily practice\nand habits and cultivate a kind hearth.\nAbandon impatience and instead be\ncontent creating the causes fro goodness.\nSoon you will se the results.";
let nSlider;
...
function draw() {
  ...
  noStroke();
  rectMode(CENTER);
  rect(windowWidth / 2, windowHeight * 5.3/33, 350, 90);
  pop();
