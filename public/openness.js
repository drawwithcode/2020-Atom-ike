var stars = [];
let myText = "You wish for Openness";
let myOtherText = "Close your eyes and open your mind.\nIt is okay to be scared, but you have\nto get out there, open up, love, make mistakes,\nlearn and start all over again.";
let nSlider;
