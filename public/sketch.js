...
if (checkIfMobile()) {
  ...
  function draw() {
    ...
    fill(9, 14, 36);
    rectMode(CENTER);
    rect(windowWidth / 2, windowHeight / 1.45, 500, 130);
    pop();
    ...
    textAlign(CENTER);
    textFont("Prata");
    text(myTitle, windowWidth / 2, windowHeight / 1.5);
    pop();
    ...
    text(myText, windowWidth / 2, windowHeight / 1.4);
    pop();


    //logo animazione
    var diam = 120 + sin(theta) * maxDiameter;
    ...
    imageMode(CENTER);
    image(myImageLogo, width / 2, height / 2, diam, diam);
